...
while True:
    user = api.get_user('@Ganesh54467205')
    api.update_profile(name=f'ganesh charan|{follower_count(user)} Followers')
    print(f'Updating Twitter Name : ganesh charan|{follower_count(user)} Followers')
